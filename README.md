...
# 소개
- 삼성 SDS에서 온프레미스 인프라 관리자로 일하면서 수백대의 서버를 운영/관리 하였던 경험과, 풀스텍으로 여러 웹/앱 서비스 개발 한 경험을 통합하여 "인프라x개발" 전체를 아우르는 능력이 있습니다.
- (2026년)현재 글로벌 음악 시장을 주도하는 하이브와 국내 최고 IT 기술력을 갖춘 네이버가 손을 잡고 만든 [위버스 컴퍼니](https://weverse.co/) 에서 이커머스 개발을 하고있습니다.
   - 백만, 천만 단위의 초 대규모 트래픽으로 인한 트러블 슈팅(메모리 누수 원인분석/해결) 경험이 있습니다.
   - 로컬라이즈 다국어 지원 등 글로벌 서비스에 특화된 기능들을 많이 경험하고 있습니다.
- AI를 능숙하게 활용 가능하고, 1인 서비스 개발 및 운영 능력을 갖추었습니다.

### 두쫀쿠 월드 (Dubai World) 개발자
- 전국, 전세계 두쫀쿠 가게를 찾아보아요. 레시피, 굿즈, 메뉴 소개 등 두쫀쿠의 모든것이 있는 두쫀쿠 월드.
- 웹 사이트: https://dessert-map.vercel.map
- 인앱토스 출시: https://minion.toss.im/LQBKhd9A


# AI Platform Architecture (soon... maybe 2027)
- 빠르게 변화하는 AI시대에 제조 도메인 지식과 인프라 최적화 역량을 바탕으로 기업용 AI 플랫폼의 비용과 성능을 설계하는 AI 플랫폼 아키텍트 를 준비하고 있습니다.
  AI Agent 가 돌아가는 기반이 되는 인프라를 제공하는 사람이 되고자 합니다.
- 현재 준비중인 스킬
  - 클라우드/K8s 기반 LLM 서빙 인프라 구축
  - Quantization & Inference 튜닝 + 모니터링
  - 아키텍트 관점의 FinOps·SLA 설계
  - GraphRAG 자가진단 에이전트 플랫폼화
  - GraphRAG 파이프라인 구현 (Neo4j + VectorDB)
  - Edge–Cloud 하이브리드 + WebGPU 온디바이스
  - XAI + Three.js 3D 시각화
  - 트래픽/비용 절감 실험 설계
  

---
# Full Stack Web Programmer (2024~)
next.js + supbase 를 이용하여 온라인 쇼핑몰 1인 개발 진행
- https://meowz.co.kr
- https://artifine.kr
...
* 이미지
![image](https://user-images.githubusercontent.com/89284542/148675849-217d7a31-1b20-4515-8473-329123881d13.png)
![image](https://user-images.githubusercontent.com/89284542/148675866-1c7ee518-e960-4f45-9779-3f86d74ef77f.png)
![image](https://user-images.githubusercontent.com/89284542/148675949-f67bca85-aaa8-4f3c-bae7-96a093f8af04.png)
...
* 목표
  * Open API 연동 
    * 날씨 Open API [OpenWeather](https://openweathermap.org/api)를 사용하여 현재 지역의 날씨/온도 호출
  * Javascript 스터디
...
- 설명 : 랜덤하게 지뢰가 숨겨진 크기가 NxN의 판 위에서 플레이어가 목적지까지 횡단하는 지뢰 피하기 퍼즐게임. 
             주변에 숨겨진 지뢰의 숫자를 나타내는 '등대'를 보고 지뢰의 위치를 유추하고 아이템을 활용하면서 최소한의 횟수로 목적지에 도착하면 높은 점수를 얻을 수 있습니다.   
...
- [git page: pyexcel](https://snowman95.github.io/pyexcel/docs/source/_build/html/index.html)   
