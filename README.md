...
# 소개
- 삼성 SDS에서 온프레미스 인프라 운영자로 일하면서 수백대의 서버를 운영/관리 하였던 경험과, 풀스텍으로 여러 웹/앱 서비스 개발 한 경험을 통합하여 "인프라x개발" 전체를 아우르는 능력이 있습니다.
...
온라인 쇼핑몰 1인 개발 진행. 인증,전시,결제 등 커머스 영역의 전체 코드 개발
- 고양이와 집사를 위한 따뜻한 동반자 MEOWZ: https://meowz.co.kr
- 각 상품이 고유한 ID를 가지고 인증서를 발급하는 쇼핑몰 https://artifine.kr
